...
<section class="content">
    <div class="card">
        <div class="card-header">
              <h3 class="card-title">Crear nueva sub-categoría</h3>
        </div>
...
<script src="{{ asset('admin/jscontrollers/subcategories/create.js') }}"></script>
@endsection
@else 
