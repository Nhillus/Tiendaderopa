            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-md-6 col-lg-6">
                        ...
                        <input type="text" name="name" id="id_name" class="form-control" placeholder="Nombre de la categoría" value="{{ $category->name }}">
                    ...
                    <div class="form-group col-md-6 col-lg-6">
                        ...
                        <select class="form-control select2bs4" id="id_promotion_id" style="width: 100%;" name="promotion_id">
                            ...
                            <option {{ $category->promotion->id == $p->id ? 'selected' : '' }} value="{{ $p->id }}">{{ $p->title }}</option>
                            @endforeach
                        </select>
