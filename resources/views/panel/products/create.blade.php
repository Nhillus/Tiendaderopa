            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-md-6 col-lg-6">
                        ...
                        <input type="text" name="title" id="id_title" class="form-control" placeholder="Título del producto">
                    ...
                    <div class="form-group col-md-6 col-lg-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control numeric" id="id_real_price" name="real_price" placeholder="Precio real del producto">
                        </div>
                    ...
                    <div class="form-group col-md-6 col-lg-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control numeric" readonly id="id_offer_price" name="offer_price" placeholder="Precio de descuento">
                        </div>
                    ...
                    <div class="form-group col-md-6 col-lg-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control numeric" id="id_offer_percent" name="offer_percent" placeholder="Porcentaje del descuento">
                        </div>
                    ...
                    <div class="form-group col-md-6 col-lg-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control numeric" id="id_shipping_price" name="shipping_price" placeholder="Precio de envío">
                        </div>
                    ...
                    <div class="form-group col-md-6 col-lg-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control numeric" id="id_shipping_days" name="shipping_days" placeholder="Días del envío">
                        </div>
                        <span class="error-message" validation-name="offer_percent"></span>
                    </div>
                    ...
                    <div class="form-group col-md-12 col-lg-12">
                        ...
                        <textarea placeholder="Descripción del producto" id="id_description" name="description" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
...
<script src="{{ asset('admin/jscontrollers/products/products.js') }}"></script>
<script src="{{ asset('admin/jscontrollers/products/create.js') }}"></script>
@endsection
@else 
