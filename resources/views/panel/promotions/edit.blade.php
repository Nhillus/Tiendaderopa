...
<section class="content">
    <div class="card">
        <div class="card-header">
              <h3 class="card-title">Editr una promoción</h3>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-md-6 col-lg-6">
                        ...
                        <input type="text" name="title" id="id_title" class="form-control" placeholder="Nombre de la promoción" value="{{ $promotion->title }}">
                        <span class="error-message" validation-name="title"></span>
                    </div>

                    <div class="form-group col-md-6 col-lg-6">
                        <label for="id_shipping">Tipo de entrega</label>
                        <input type="text" name="shipping" id="id_shipping" class="form-control" placeholder="Tipo de entrega" value="{{ $promotion->shipping }}">
                    ...
                    <div class="form-group col-md-6 col-lg-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control numeric" name="offer_percent" id="id_offer_percent" placeholder="Porcentaje de descuento" value="{{ $promotion->offer_percent }}">
                        </div>
