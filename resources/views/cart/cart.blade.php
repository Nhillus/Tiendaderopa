                    ...
                    <div id="my-cart-selector" class="my-cart my-cart-selector clearfix">
                        ...
                        <div class="row panel address-shipping-billing " id="address_area">
                            <div class="my-panel my-delivery small-12 medium-6 columns shipping customer-has-addresses">
                                ...
                                <p>
                                    <button class="btn btn-lebuya" type="button" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                                        Agregar Direccion
                                    </button>
                                </p>
                            ...
                            <div class="columns small-12 medium-7">
                                ...
                                <form action="#" method="post" data-abide="ajax" class="discount" novalidate="novalidate">
                                    ...
                                    <div class="container-validate-button">
                                        <font style="vertical-align: inherit;">
                                            <font style="vertical-align: inherit;">
                                                <input id="validate-discount" class="button button-accent button-xs" type="submit" value="Redimir"></font>
                                        </font>
                                    </div>
                                </form>
                            </div>
